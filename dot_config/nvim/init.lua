...
-- Center third doesn't scroll.
vim.o.scrolloff = math.floor(vim.o.lines / 3)
...
--       keycodes (commented out: doesn't work right for me: WSL(windows term,
--       tmux or not)
...
require('lazy').setup({
  ...
  -- TODO: Clean up this comment section. (move things I want to learn to
  --       TODO.md, remove the rest.
  ...
  },
  {
    ...
    config = function()
      ...
      -- Extend mason auto install list by tools (put LSPs above)
  ...
  { -- colorcolumn with increasing visual intensity when line approaches it
    -- TODO: fix config / need something different (I couldn't make config work
    -- so far)
  ...
  {
    -- TODO: adjust the pattern when [...] is merged (breaks currently):
    -- https://github.com/folke/todo-comments.nvim/pull/381
    'folke/todo-comments.nvim',
    event = 'VimEnter',
    dependencies = { 'nvim-lua/plenary.nvim' },
    opts = {
      -- nvim kickstart had false for gutter symbols:
      -- signs = false,
      highlight = {
        -- Default adjusted to make trailing : optional.
        -- pattern = [[.*<(KEYWORDS)\s*:?]],
      },
      search = {
        -- Default adjusted to make trailing : optional.
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      -- TODO: fix which-key: incomplete, ex 'q' for quote doesn't show
      ...
      -- TODO: these comments are not correct, ex sd' seems to work differently
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'd', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
      auto_install = true,
      highlight = {
        enable = true,
